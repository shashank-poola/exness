      ...
      <nav className="relative z-50 px-6 lg:px-12 py-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-center">
            ...
            <Button 
              asChild 
              className="rounded-12px px-8 h-11 font-extrabold text-sm"
            >
      ...
      <section className="relative px-6 py-24 md:py-32 lg:py-40">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <Button 
            asChild 
            size="lg" 
            className="text-base font-extrabold px-10 py-5 h-auto rounded-12px transition-all duration-300 hover:scale-105"
          >
